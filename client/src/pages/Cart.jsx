...
const Cart = () => {
    ...
    if (cartItems.length === 0) {
        return (
            <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-orange-50/30 to-white flex items-center justify-center px-4">
                <div className="text-center space-y-4 max-w-sm">
                    ...
                    <a href="/products"
                        className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-xl transition-colors shadow-md shadow-orange-200 mt-2">
                        Browse Products →
                    </a>
                </div>
            </div>
            ...
            <div className="bg-white border-b border-gray-100 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <a href="/products" className="text-sm font-semibold text-orange-500 hover:text-orange-600 transition-colors">
                            ← Continue shopping
                        </a>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                            ...
                            <div className="hidden sm:block overflow-x-auto">
                                <table className="min-w-full">
                                    ...
                                    <tbody>
                                        {cartItems.map((item) => (
                                            <tr key={item.product} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors group">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative">
                                    <select id="location" value={deliveryLocation}
                                        ...
                                        className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-400/25 focus:border-orange-400 focus:bg-white transition-all">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <textarea id="instructions" rows={3} value={instructions}
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-orange-400/25 focus:border-orange-400 focus:bg-white transition-all"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-80 shrink-0 sticky top-20">
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                            <div className="p-5 border-b border-gray-100 bg-gradient-to-br from-orange-50 to-white">
                            ...
                            <div className="p-5 space-y-3">
                                ...
                                {cartItems.map((item) => (
                                    <div key={item.product} className="flex justify-between text-sm">
                                        <span className="text-gray-600 truncate max-w-[160px]">{item.name} ×{item.qty}</span>
                                ...
                                {/* Wallet */}
                                <div className={`flex items-center justify-between p-3 rounded-xl text-sm font-medium ${isAffordable ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                                    <div>
                                        <p className="font-semibold text-gray-800">Wallet Balance</p>
                                ...
                                <button
                                    ...
                                    className="w-full py-3 px-6 bg-orange-500 hover:bg-orange-600 active:scale-[0.98] text-white font-bold rounded-xl shadow-md shadow-orange-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
                                >
                                    Place Order →
                                </button>
