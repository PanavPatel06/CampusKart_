...
const { addOrderItems, getMyOrders, clearMyOrders, getVendorOrders, updateOrderStatus, getAvailableDeliveryOrders, getAllOrders, getMyDeliveries } = require('../controllers/orderController');
...
router.route('/myorders/clear').put(protect, clearMyOrders);
